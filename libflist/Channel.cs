...
namespace libflist
{
	public class Channel : IDisposable
	{
		...
		public Character Owner { get { return _Characters.FirstOrDefault(c => c.Name == _OwnerName) ?? new Character(Chat, _OwnerName); } }
			...
			case "JCH":
				{
					...
					if (Title == null && !string.IsNullOrEmpty(jch.Title))
						Title = jch.Title;
				} return true;
			...
			case "RMO":
				{
					...
					if (OnModeChange != null)
						OnModeChange(this, new ChannelEntryEventArgs<ChannelMode>(this, rmo.Mode, rmo));
			...
			case "CSO":
				{
					...
					var owner = _Characters.FirstOrDefault(c => c.Name == cso.Character) ?? new Character(Chat, cso.Character);

					if (OnOwnerChange != null)
						OnOwnerChange(this, new ChannelEntryEventArgs<Character>(this, owner, cso));
			...
			case "RST":
				{
					...
					if (OnStatusChange != null)
						OnStatusChange(this, new ChannelEntryEventArgs<ChannelStatus>(this, rst.Status, rst));
